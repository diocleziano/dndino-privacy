...
!!! tip
    Da **Modifica Avventura** arrivando alla sezione riservata alle immagini è possibile rimuovere le immagini, modificare il nome visualizzato nella `Dashboard` e decidere se l'immagine può essere mostrata al master e/o nella `Finestra Giocatori`
### Mappe
...
- le pagine figlie spiegheranno **come si usa davvero ogni sezione interna**
